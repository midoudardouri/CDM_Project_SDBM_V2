<h1>Modification d'un Ticket</h1>

<form action="<?= PATH ?>/tickets/modif_sauve/<?= $ticket['ANNEE'] ?>/<?= $ticket['NUMERO_TICKET'] ?>" method="POST">
...
<hr/>
<?php
require_once(ROOT."views/vendres/lignes.php");